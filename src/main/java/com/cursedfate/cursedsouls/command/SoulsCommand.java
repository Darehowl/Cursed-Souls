...
package com.cursedfate.cursedsouls.command;
...
public class SoulsCommand {
	...
	public static void registerCommand(RegisterCommandsEvent event) {
		event.getDispatcher().register(Commands.literal("cursedfate")

				.then(Commands.literal("Souls").then(Commands.literal("AwakenSoul").executes(arguments -> {
					...
					RemoveSoulProcedure.execute(entity);
					return 0;
				}))));
	}
}
